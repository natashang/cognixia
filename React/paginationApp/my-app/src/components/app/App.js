...
export default class App extends React.Component {
  ...
  componentDidMount() {
    axios
      ...
      .then(resp => {
        this.setState({ listOfUsers: resp.data.data });
      })
  ...
  render() {
    return (
      <div>
        <h1 style={{ textAlign: "center" }}>Check out this pagination app! </h1>

        <Router links={this.state.links} changePage={this.changePage} />
        <Container listOfUsers={this.state.listOfUsers} />
      </div>
    );
  }
}
